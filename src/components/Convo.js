...
function Convo({ person, setShow, setMessage, search }) {
  ...
  useEffect(() => {
    ...
    axios
      .post("https://chatline-gz0q.onrender.com/conversation-api/get-messages", {
        host: hosting,
  ...
  const handleDownload = async (obj) => {
    try {
      let response = await axios.post(
        "https://chatline-gz0q.onrender.com/conversation-api/download-file",
        obj,
        { responseType: "blob" }
      );
  ...
  function handleDelete() {
    ...
    axios
      .post(
        "https://chatline-gz0q.onrender.com/conversation-api/delete-message",
        deleteObject
      )
      .then((res) => {
